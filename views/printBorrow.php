		...
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">SNDT WOMEN'S UNIVERSITY</p>
					<p style="margin:0;padding:0;font-weight:bold;">Shreemati Nathibai Damodar Thakersey WOMEN's UNIVERSITY</p>
					<p style="margin:0;padding:0;">New Marine Lines,Churchgate,Mumbai,Maharashtra400020</p>
				</td>
